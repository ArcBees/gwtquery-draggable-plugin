...
public class DraggableOptions extends MouseOptions {
   ...
   *
   * @param appendTo the selector defining the element where the helper will be added
   */
   ...
   *
   * @param helper element used as helper during the drag
   */
   ...
   * of the drag and removed after.
   *
   * @param helper GQuery object containing the element that will be used as helper
   *               during the drag
   */
   ...
   *
   * @param helperType the helper type
   */
   ...
   * of the drag and removed after.
   *
   * @param helper css selector defining the element that will be used as helper
   *               during the drag
   */
   ...
   * operation.
   *
   * @param onDragStart function called before the initialization of the drag operation.
   */
   ...
   *
   * @param onDragStart function called when the drag operation is dragging.
   */
   ...
   *
   * @param onDragStart function called when the drag operation starts.
   */
   ...
   *
   * @param onDragStart function called when the drag operation ends.
   */
   ...
   *
   * @param onSelected callback function called when a draggable is selected.
   */
   ...
   *
   * @param onUnselected callback function called when a draggable is unselected.
   */
